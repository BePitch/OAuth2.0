...
email="Billy@InsanelyRich.com",name="Bill Gates",picture="bgates.jpg")
                       
session.add(User1)
session.commit()

User2 = User(   username="ShantAdobe",password="shant543",
email="Shantanu@adobe.com",name="Shantanu Narayen",picture="AdobeCEO.jpg")
                       
session.add(User2)
session.commit()

User3 = User(   username="AdamSel1",password="selinskyPop",
email="AdamSel@tableau.com",name="Adam Selipsky",picture="TableauCEO.jpg")
...
year_published="2015",category="Media Editing",created_date=str(now),
...
category="Data",manufacturer_id=1,created_date=str(now),
...
category="Visualization",created_date=str(now),manufacturer_id=1,
manufacturer=manufacturer1,user_id=1)
...
category="Media Editing",created_date=str(now),manufacturer_id=2,
...
year_published="2018",category="Media Editing",created_date=str(now),
...
year_published="2018",category="Visualization",created_date=str(now),
manufacturer_id=3,manufacturer=manufacturer3,user_id=3)
